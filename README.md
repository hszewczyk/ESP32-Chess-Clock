...
1. Upload `I2C-Address/I2C-Address.ino` and run it
2. Input address of the I2C and Access Point credentials to `Chess-Clock/Chess-Clock.ino` file
3. Upload `Chess-Clock/Chess-Clock.ino` to ESP32 board
